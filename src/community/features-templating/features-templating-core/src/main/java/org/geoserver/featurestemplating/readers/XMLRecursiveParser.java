...
public class XMLRecursiveParser extends RecursiveTemplateResourceParser implements AutoCloseable {
    ...
    public XMLRecursiveParser(Resource resource, NamespaceSupport namespaceSupport) throws IOException{
        super(resource);
    ...
    public XMLRecursiveParser(Resource resource, XMLRecursiveParser parent, NamespaceSupport namespaceSupport) throws IOException {
    ...
    public void iterateReader(TemplateBuilder builder)
            throws IOException {
        try {
    ...
    private void templateBuilderFromCharacterElement(
        ...
        if (element.getName().toString().equals(INCLUDE_FLAT)){
            builderFromIncludedTemplate(resource,data,currentParent);
                ...
                builderFromIncludedTemplate(resource,path,currentParent);
        }
    ...
    private void builderFromIncludedTemplate(Resource resource, String data, TemplateBuilder currentParent) throws IOException {
        ...
        try(XMLRecursiveParser recursiveParser= new XMLRecursiveParser(included,this,namespaceSupport)) {
