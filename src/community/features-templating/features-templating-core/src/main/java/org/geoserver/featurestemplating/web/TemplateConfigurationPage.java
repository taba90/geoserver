...
public class TemplateConfigurationPage extends GeoServerSecuredPage {
    ...
    private void initUI(IModel<TemplateInfo> model) {
        ...
        if (wsDropDown.getValue()==null || wsDropDown.getValue()=="-1")
            ...
            ftiDropDown.setChoices(getFeatureTypesInfo(wsDropDown.getModelObject()));
        ...
        return new ConfirmOverwriteSubmitLink("upload", this.form) {
            ...
            protected void onSubmit(AjaxRequestTarget target, Form<?> form) {
                ...
                try {
                    ...
                    getTemplateConfPage().setRawTemplate(
                ...
                TemplateInfo templateInfo=getTemplateConfPage().getTemplateInfoModel().getObject();
                if (templateInfo.getTemplateName() == null || "".equals(templateInfo.getTemplateName().trim())) {
                    // set it
                    String fileName=upload.getClientFileName();
                    templateName.setModelValue(
                            new String[] {
                                    ResponseUtils.stripExtension(fileName)
                            });
                            ...
                            new AjaxCallListener() {
                                ...
                                public CharSequence getPrecondition(Component component) {
                                    CharSequence message =
                                            new ParamResourceModel("confirmOverwrite", getTemplateConfPage())
                                                    .getString();
