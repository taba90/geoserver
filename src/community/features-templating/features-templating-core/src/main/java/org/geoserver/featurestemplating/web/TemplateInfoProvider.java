...
public class TemplateInfoProvider extends GeoServerDataProvider<TemplateInfo> {
    ...
    public static final Property<TemplateInfo> NAME = new BeanProperty<>("templateName", "templateName");
    public static final Property<TemplateInfo> EXTENSION =
            new BeanProperty<>("extension", "extension");
    public static final Property<TemplateInfo> WORKSPACE = new BeanProperty<>("workspace", "workspace");
    public static final Property<TemplateInfo> FEATURE_TYPE_INFO = new BeanProperty<>("featureTypeInfo", "featureType");
