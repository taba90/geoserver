...
public class GeofenceGetMapIntegrationTest extends WMSTestSupport {
    ...
    @Test
    public void testClippingSpatialFilter() throws Exception {
        // tests that layer contained in NamedTree LayerGroup has the AccessInfo overrided
        // when directly access
        UserAdminService userAdminService =
                (UserAdminService) applicationContext.getBean("userAdminService");
        UserGroupAdminService userGroupAdminService =
                (UserGroupAdminService) applicationContext.getBean("userGroupAdminService");
        Long ruleId1 = null;
        Long ruleId2 = null;
        Long ruleId3 = null;
        try {
    ...
    static void addRuleLimits(
        ...
        if (spatialFilterType == null) spatialFilterType = SpatialFilterType.INTERSECTS;
